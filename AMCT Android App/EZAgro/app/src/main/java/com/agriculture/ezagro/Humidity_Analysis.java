...
public class Humidity_Analysis extends Analysis_Fragment {

    private FirebaseAuth fauth;
    private FirebaseUser user;
    private DatabaseReference fref;
    private String uid,email,parent,temp,temp2,year,month,day,hum_value,humidity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_humidity__analysis, container, false);

        graphView=(GraphView) v.findViewById(R.id.hum_graph);
        ...
        gridLabel.setVerticalAxisTitle("Humidity in %");
                                                        ...
                                                        for (DataSnapshot ds4 : ds3.getChildren()) {
                                                            ...
                                                            for (DataSnapshot ds5 : ds4.getChildren()) {
                                                                ...
                                                                for (DataSnapshot ds6 : ds5.getChildren()) {
                                                                    hum_value = ds6.getValue(String.class);
                                                                    String temp1[] = hum_value.split("%");
                                                                    humidity = temp1[0];
                                                                    list.add(Float.parseFloat(humidity));
                                                                }
                                                                float total = 0;
