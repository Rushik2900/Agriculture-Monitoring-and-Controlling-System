...
public class SoilMoisture_Analysis extends Analysis_Fragment {

    private FirebaseAuth fauth;
    private FirebaseUser user;
    private DatabaseReference fref;
    private String uid,email,parent,temp,temp2,year,month,day,soil_value,SoilMoisture;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_soil_moisture__analysis, container, false);

        graphView=(GraphView) v.findViewById(R.id.soil_graph);
        ...
        gridLabel.setVerticalAxisTitle("Soil Moisture in %");
                                                        ...
                                                        for (DataSnapshot ds4 : ds3.getChildren()) {
                                                            ...
                                                            for (DataSnapshot ds5 : ds4.getChildren()) {
                                                                ...
                                                                for (DataSnapshot ds6 : ds5.getChildren()) {
                                                                    soil_value = ds6.getValue(String.class);
                                                                    String temp1[] = soil_value.split("%");
                                                                    SoilMoisture = temp1[0];
                                                                    list.add(Float.parseFloat(SoilMoisture));
                                                                }
                                                                float total = 0;
